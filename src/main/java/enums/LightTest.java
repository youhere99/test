 ...
 * Description.
 * <p>
 * Copyright: Copyright (c) 2016年11月21日 下午3:47:20
 * <p>
 * Company: 翡翠教育
 * <p>
 * 
...
public class LightTest {
	...
	private static void testEnumMap() {
		...
		// 2.遍历对象
		Iterator<Light> it = currEnumMap.keySet().iterator();
		while (it.hasNext()) {
			Light aLight = it.next();
	...
	private static void testEnumSet() {
		...
		for (Light aLightSetElement : currEnumSet) {
			...
			System.out.println("当前灯name：" + aLightSetElement.name());

			System.out.println("当前灯ordinal：" + aLightSetElement.ordinal());

			System.out.println("当前灯：" + aLightSetElement);
		}
