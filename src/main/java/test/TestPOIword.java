...
public class TestPOIword {
	...
	public static void main(String[] args) throws IOException {
		...
		r5
		        .setText("When we have shuffled off this mortal coil," + "Must give us pause: there's the respect"
		...
		FileOutputStream out = new FileOutputStream("C:\\Users\\Administrator\\Desktop\\simple.docx");
		doc.write(out);
		out.close();
		System.out.println("=========================");
	}
