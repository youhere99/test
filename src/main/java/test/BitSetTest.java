...
/**
 * Title.<br>
 * Description. https://my.oschina.net/cloudcoder/blog/294810
 * <p>
 * Copyright: Copyright (c) 2017年6月27日 下午5:03:56
 * <p>
 * Company: 翡翠教育
 * <p>
 * 
...
public class BitSetTest {
	...
	public static void main(String args[]) {
		// BitSet使用示例
		BitSetTest.containChars("How do you do? 你好呀");
		BitSetTest.computePrime();
		BitSetTest.sortArray();
		BitSetTest.simpleExample();
		...
		// 将BitSet对象转成byte数组
		byte[] bytes = BitSetTest.bitSet2ByteArray(bitSet);
		System.out.println(Arrays.toString(bytes));

		// 在将byte数组转回来
		bitSet = BitSetTest.byteArray2BitSet(bytes);
		System.out.println(bitSet.size() + "," + bitSet.cardinality());
