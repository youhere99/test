...
public class ReflectDemo {
	...
	public static void demo1() {
		...
		System.out.println("包名：" + Persons.getClass().getPackage().getName());
		System.out.println("完整类名：" + Persons.getClass().getName());
	}
	...
	public static void demo3() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		Persons Persons = (Persons) class1.newInstance();
		Persons.setName("xiaoming");
		Persons.setAge(20);
	 ...
	 */
	public static void demo4() throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException,
		...
		person1 = (Persons) constructors[0].newInstance();
		person1.setName("xiaoming");
		person1.setAge(20);
		System.out.println(person1.getName() + " , " + person1.getAge());
		person2 = (Persons) constructors[1].newInstance(21, "xiaohong");
	...
	public static void demo5() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchFieldException, SecurityException {
		Class<?> class1 = Class.forName("com.reflect.Persons");
	...
	public static void demo6() throws ClassNotFoundException {
		Class<?> class1 = Class.forName("com.reflect.SuperMan");
	 ...
	 */
	public static void demo7() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InstantiationException,
	        InvocationTargetException {
		Class<?> class1 = Class.forName("com.reflect.SuperMan");
	...
	public void testMethod() {
		try {
			Class<TestMath> clazz = (Class<TestMath>) Class.forName("test.TestMath");
